                ...
                <div className="row">
                    <div className="col-sm-12" style={{ minHeight: '75px' }}>
                        ...
                        <ul className="social-block">
                            {social_links.facebook !== '' && <li><a rel="noopener noreferrer" href={`https://${social_links.facebook}`} target="_blank"><span className="fa fa-facebook"></span></a></li>}
                            {social_links.twitter !== '' && <li><a rel="noopener noreferrer" href={`https://${social_links.twitter}`} target="_blank"><span className="fa fa-twitter"></span></a></li>}
                            {social_links.linkedin !== '' && <li><a rel="noopener noreferrer" href={`https://${social_links.linkedin}`} target="_blank"><span className="fa fa-linkedin"></span></a></li>}
                            {social_links.instagram !== '' && <li><a rel="noopener noreferrer" href={`https://${social_links.instagram}`} target="_blank"><span className="fa fa-instagram"></span></a></li>}
                            {social_links.pinterest !== '' && <li><a rel="noopener noreferrer" href={`https://${social_links.pinterest}`} target="_blank"><span className="fa fa-pinterest"></span></a></li>}
                            {social_links.github !== '' && <li><a rel="noopener noreferrer" href={`https://${social_links.github}`} target="_blank"><span className="fa fa-github"></span></a></li>}
                        </ul>
                    </div>
                </div>
