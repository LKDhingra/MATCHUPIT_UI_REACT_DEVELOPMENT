                ...
                <div className="row">
                    <div className="col-xs-12" style={{ minHeight: '75px' }}>
                        ...
                        <ul className="social-block">
                            ...
                            {state.profile.social_links.linkedin !== '' && <li><a rel="noopener noreferrer" href={`https://linkedin.com/${state.profile.social_links.linkedin}`} target="_blank"><span className="fa fa-linkedin"></span></a></li>}
